...
namespace kera
{
    ...
    public:
        ...
        bool initialize(const Device& device, VkPipelineCache pipeline_cache, std::span<const VkFormat> color_formats,
                        VkFormat depth_format, VkSampleCountFlagBits sample_count,
